  ...
  theme: {
    extend: {
      ...
      screens: {
        ...
        // Tablets
        'tablet-portrait': '744px', // iPad Mini Portrait
        'tablet': '820px', // iPad Portrait
        'lg': '1024px', // iPad Pro Portrait / Small Desktop
        'tablet-landscape': '1133px', // iPad Mini Landscape
        'xl': '1180px', // iPad Landscape
        'tablet-pro': '1366px', // iPad Pro Landscape
        // Laptops
        'laptop-sm': '1440px', // MacBook 13"
        'laptop': '1512px', // MacBook 14"
        'laptop-lg': '1680px', // MacBook 15"
        'laptop-xl': '1728px', // MacBook 16"
        // Large screens
        '2xl': '1920px',
        '3xl': '2560px',
        '4xl': '3840px', // 4K
