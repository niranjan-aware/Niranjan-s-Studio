...
export default function Hero() {
  return (
    <div className="hero-container min-h-screen relative max-w-7xl flex xs:flex-col xs:space-y-10 space-y-0 md:flex-row-reverse md:h-screen items-center justify-evenly mx-auto">
      ...
      <div className="title space-y-6">
        ...
        <div className="headings space-y-2">
          ...
          <h1 className="heading xs:text-3xl sm:text-4xl md:text-5xl lg:text-7xl xl:text-7xl font-bold text-teal leading-tight">
            WITH CODE & DESIGN
          </h1>
        </div>
        ...
        <div className="contact-btn font-semibold xs:font-normal flex flex-row xs:space-x-4 md:space-x-8 pt-4">
          ...
          <div className="download-btn group flex items-center xs:px-4 xs:py-2 md:space-x-2 md:px-6 md:py-3 bg-gradient-to-r from-slate-600/30 to-slate-500/30 rounded-full text-white hover:text-teal hover:from-teal/20 hover:to-cyan-400/20 transition-all duration-500 border-2 border-slate-600 hover:border-teal/50 shadow-lg hover:shadow-teal/20 hover:scale-105 transform">
            ...
            >
              ...
              <TbFileDownload className="group-hover:animate-bounce" />
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="social-media-btn absolute xs:bottom-44 xs:right-5 sm:bottom-72 sm:right-5 md:bottom-52 md:right-5 flex flex-col items-center justify-center space-y-6">
        ...
        >
          <FaLinkedin className="md:w-10 md:h-10 xs:w-8 xs:h-8 text-white hover:text-blue-400 transition-all duration-300 group-hover:scale-110 transform" />
        </a>
        ...
        <a
          ...
          className="social-icon group"
        >
          <SiGmail className="md:w-9 md:h-9 xs:w-7 xs:h-7 text-white hover:text-red-400 transition-all duration-300 group-hover:scale-110 transform" />
        </a>
        ...
        <a
          ...
          className="social-icon group"
        >
          <FaGithubSquare className="md:w-10 md:h-10 xs:w-8 xs:h-8 text-white hover:text-purple-400 transition-all duration-300 group-hover:scale-110 transform" />
        </a>
