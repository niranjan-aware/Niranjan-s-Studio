    ...
    <div className="min-h-screen text-white p-4 lg:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4  bg-gradient-to-r from-[#caf0f8] via-[#90e0ef] to-[#00b4d8] bg-clip-text text-transparent">
            Professional Journey
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Building scalable solutions and continuously learning in the world
        ...
        <div className="relative">
          {/* Central Line */}
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-cyan-400 via-purple-500 to-pink-500 rounded-full hidden lg:block"></div>

          {/* Mobile Line */}
          <div className="absolute left-8 w-1 h-full bg-gradient-to-b from-cyan-400 via-purple-500 to-pink-500 rounded-full lg:hidden"></div>
              ...
              >
                <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-700 overflow-hidden hover:border-gray-600 transition-all duration-300 transform hover:-translate-y-2 hover:shadow-2xl">
                  ...
                  <div className="p-6 relative overflow-hidden">
                    {/* Background Pattern */}
                    <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-cyan-500/10 to-purple-500/10 rounded-full transform translate-x-16 -translate-y-16"></div>
        ...
        <div className="mt-16 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl border border-gray-700 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">
                C/C++, Java, JavaScript, HTML, CSS, SQL
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">
                Spring Boot, Node.js, REST APIs, RabbitMQ
              </p>
            </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 text-sm">
            "Passionate about creating scalable solutions and continuous
            learning"
          </p>
        </div>
      </div>
