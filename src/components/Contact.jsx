...
export default function Contact() {
  ...
  const getSubmitButtonClass = () => {
    if (submitStatus === 'sending') return 'bg-gradient-to-r from-gray-600 to-gray-700';
    if (submitStatus === 'success') return 'bg-gradient-to-r from-green-500 to-emerald-500';
    if (submitStatus === 'error') return 'bg-gradient-to-r from-red-500 to-red-600';
        ...
        <div className="hidden lg:flex bg-gradient-to-br from-gray-900 to-gray-800 items-center justify-center relative overflow-hidden">
          <div className="w-full h-full flex items-center justify-center relative">
            ...
            <div className="absolute inset-0 pointer-events-none">
              ...
              <div className="absolute bottom-24 right-20 w-6 h-6 bg-gradient-to-r from-purple-400/40 to-purple-600/40 rounded transform rotate-45 animate-bounce" style={{animationDelay: '1s'}}></div>
              <div className="absolute top-32 right-8 w-4 h-4 bg-gradient-to-r from-pink-400/40 to-pink-600/40 rounded-full animate-ping" style={{animationDelay: '2s'}}></div>
            </div>
          </div>
          ...
          <div className="absolute bottom-8 left-8 right-8">
            <div className="space-y-3">
              <div className="flex gap-3 mt-4">
                <a href="https://www.linkedin.com/in/niranjan-aware-673019211/" target="_blank" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors duration-300 hover:-translate-y-1 transform">
                  <FaLinkedin className="w-4 h-4" />
                </a>
                <a href="mailto:niranjanaware26@gmail.com" target="_blank" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors duration-300 hover:-translate-y-1 transform">
                  <SiGmail className="w-4 h-4" />
                </a>
                <a href="https://github.com/niranjan-aware" target="_blank" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors duration-300 hover:-translate-y-1 transform">
