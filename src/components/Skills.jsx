...
export default function Skills() {
  ...
  const reactjsIcon =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574170/react_mb7olv.svg";
  const cssIcon =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574911/Brand_css_Style_Light_rw3w41.svg";
  const githubIcon =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574168/Platform_Github_Color_Original_q8tvt1.svg";
  const jsIcon =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574157/Brand_js_Style_Light_hztanc.svg";
  const mongodbIcon =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574911/Brand_mongodb_Style_Light_ychvmg.svg";
  const nodejsIcon =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574159/Brand_nodejs_Style_Light_ps32ag.svg";
  const tailwindIcon =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574160/Brand_tailwind_Style_Light_cg0ibf.svg";
  const html5Icon =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574155/Brand_html5_Style_Light_zzeltr.svg";
  const postgreSQL =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574169/postgreSQL_wapxln.svg";
  const Bamboo =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574157/Bamboo_jrxdto.svg";
  const Docker =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574161/Docker_pmickf.svg";
  const intellij =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574165/IntelliJ_IDEA_diivva.svg";
  const VS =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574171/Visual_Studio_Code_VS_Code_qtf6zf.svg";
  const splunk =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574170/splunk_wwchda.svg";
  const springboot =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574170/springboot_nysbuo.svg";
  const Java =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574165/Java_b0v94f.svg";
  const cpp =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574161/C_CPlusPlus_l1utq6.svg";
  const vitejs =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574161/Brand_vitejs_Style_Light_cxlm7w.svg";
  const redux =
    "https://res.cloudinary.com/dlf06uxsc/image/upload/v1748574160/Brand_redux_Style_Light_qoap62.svg";
  const skillsData = [
  ...
  return (
    <div
      id="skills"
      className="flex font-bold flex-col items-center justify-center px-4 py-20 w-screen xs:mt-20 md:mt-40 xs:mb-20 mb-40"
    >
            ...
            {filteredSkills.map((skill, index) => (
              ...
              >
                <div className="shadow-2xl xs:w-20 xs:h-24  w-[105px] h-[115px] md:w-[85px] md:h-[90px] relative rounded-lg ">
                  <div
                    className={`absolute inset-0 ${getLevelColor(
                      skill.level
